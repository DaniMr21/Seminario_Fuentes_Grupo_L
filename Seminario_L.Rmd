...
1. **Limpieza y homogeneización** de ambas tablas (`aire` y `fertilidad`), incluyendo la estandarización de nombres de país (`pais`) y la conversión de años (`anio`).
...
De manera más simplificada, la intensidad de vigilancia del aire no parece explicar las diferencias de fertilidad entre países europeos. Esto sugiere que la hipótesis naïf (“más vigilancia → más fertilidad”) no se sostiene empíricamente en este corte transversal.
...
**Pregunta:** ¿Existe una relación entre los niveles medios de NO₂ en cada país europeo y su fertilidad media?

**Hipótesis:** Esperamos observar una relación **negativa**, es decir, que países con mayor NO₂ medio deberían presentar, en promedio, niveles más bajos de fertilidad.  
