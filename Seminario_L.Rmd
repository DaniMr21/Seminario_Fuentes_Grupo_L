...
Para determinar si la correlación débil ($\rho \approx 0.045$) observada en el gráfico es estadísticamente significativa o simplemente un producto del azar en esta muestra, se utiliza una prueba de significancia de la correlación de Pearson (`cor.test`).
